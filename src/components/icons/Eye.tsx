export const EyeIcon = () => {
  return (
    ...
    >
      ...
      />
      <path
        d="M14.1213 9.87868C15.2929 11.0503 15.2929 12.9498 14.1213 14.1213C12.9497 15.2929 11.0502 15.2929 9.87868 14.1213C8.70711 12.9498 8.70711 11.0503 9.87868 9.87868C11.0502 8.70711 12.9497 8.70711 14.1213 9.87868"
        stroke="#828282"
        strokeWidth="1.4286"
        strokeLinecap="round"
        strokeLinejoin="round"
